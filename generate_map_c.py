"""
Weather Map Generation script for location c: Randangan Area
"""
...
# Test location
LOCATIONS = [
    (0.582721,121.291988),(0.716684,121.967408),(0.834690,121.595142),
    (0.449890,121.800488),(0.577649,121.552066),(0.906919,121.833410),
    (0.684399,121.750814),(0.774285,121.391439),(0.587349,121.874786),
    (0.460289,121.133057),(0.483252,121.430095),(0.548317,121.688382),
    (0.641948,121.426263),(0.820464,121.731157),(0.709036,121.545009),
    (0.713545,121.274773),(0.768192,121.845260),(0.647970,121.640276),
    (0.484172,121.321123),(0.748587,121.657740),
]

MAP_CENTER = [0.639296, 121.595870]
ZOOM_START = 10
# ===========================================
...
def create_prediction_map():
    ...
    <div style="position: absolute; top: 10px; left: 50%; transform: translateX(-50%);
        ...
        Rainfall Map – Randangan & Surroundings
    </div>
    '''
    ...
    if values_peak:
        ...
        add_idw_overlay(fg_idw_peak, points_peak, values_peak, "idw_peak_c", "YlOrRd", "IDW Peak Rain (mm)_c", 
                        vmin=vmin_p, vmax=vmax_p)
        create_colorbar_png("colorbar_peak_c.png", "YlOrRd", vmin_p, vmax_p, "Peak Rainfall (mm)_c")
    ...
    if values_24h:
        ...
        add_idw_overlay(fg_idw_24h, points_24h, values_24h, "idw_24h_c", "YlGnBu", "IDW Expected 24h (mm)_c", 
                        vmin=vmin_24, vmax=vmax_24)
        create_colorbar_png("colorbar_24h_c.png", "YlGnBu", vmin_24, vmax_24, "Expected 24h Rainfall (mm)_c")
    ...
    peak_b64 = embed_image_to_base64("colorbar_peak_c.png")
    _24h_b64 = embed_image_to_base64("colorbar_24h_c.png")
    ...
    m.save("rainfall_prediction_map_c.html")
    print("✅ Saved: rainfall_prediction_map_c.html")
# ────────────────────────────────────────────────
# Real-Time Map
# ────────────────────────────────────────────────
def create_realtime_map():
    ...
    add_idw_overlay(fg_idw, points, values, "idw_current_c", "YlGnBu", "Current 1h Rainfall_c")

    rmax = max(values) if values else 0
    vmax = max(5.0, round(rmax + 0.8, 1)) if rmax > 0 else 3.0
    create_colorbar_png("colorbar_current_c.png", "YlGnBu", 0.0, vmax, "Current 1h Rainfall (mm)_c")
    ...
    folium.LayerControl().add_to(m)
    m.save("rainfall_realtime_map_c.html")
    print("✅ Saved: rainfall_realtime_map_c.html")
